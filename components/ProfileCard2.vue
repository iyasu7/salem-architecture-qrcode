...
<template>
  <div
    class="mx-auto my-10 flex max-w-xs flex-col items-center rounded-xl border px-4 py-4 text-center md:max-w-lg md:flex-row md:items-start md:text-left"
  >
    ...
    <div class="">
      <p class="text-xl font-medium text-gray-700">{{ employee.name }}</p>
      <p class="mb-4 text-sm font-medium text-gray-500">
        {{ employee.position }}
      </p>
      <div class="flex space-x-2">
        <div
          class="flex flex-col items-center rounded-xl bg-gray-100 px-4 py-2"
        >
        ...
        <div
          class="flex flex-col items-center rounded-xl bg-gray-100 px-4 py-2"
        >
          <p class="text-sm font-medium text-gray-500">since</p>
          <p class="text-3xl font-medium text-gray-600">
            {{
              employee.joinedAt.toLocaleString("default", {
                month: "long",
                year: "numeric",
              })
            }}
